...
import ArticleScreenContainer from './news/ArticleScreenConstainer'
...
export function registerScreens(store, Provider, client) {
  ...
  Navigation.registerComponent('ArticleScreen', () => ArticleScreenContainer, store, Provider, { client: client });
